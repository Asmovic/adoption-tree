<template>
  <div class="flex">
    ...
    <div class="global-form registration-form flex flex--column">
      ...
      <h3 class="text--center text--primary">Kindly provide your personal information</h3>
      <div class="form-data-container">
        <div class="step visible">
          <form action @submit.prevent="handleSubmit">
            ...
            <div class="row">
              ...
              <div class="col-sm">
                <select-box name="gender" v-model="registration.gender" required>
        ...
        <div class="step">
          <form action @submit.prevent="handleSubmit">
            ...
            <div class="row">
              <div class="col-sm">
                <select-box name="stateOfOrigin" v-model="registration.residentStateId">
              ...
              <div class="col-sm">
                <select-box name="lgaOfResidence" v-model="registration.residentLgaId">
      ...
      <div class="action-buttons mt-auto flex justify--space-between">
        <div class="left">
          <button class="button" type="button" @click="goBack" :disabled="loading">Back</button>
        </div>
        <div class="right">
          <button
            class="button"
  ...
  methods: {
    async handleSubmit() {
      ...
      try {
        ...
        this.$store.commit(
          "showGlobalForm",
          "registration.donor.phone.confirmation"
        );
      } catch (error) {
